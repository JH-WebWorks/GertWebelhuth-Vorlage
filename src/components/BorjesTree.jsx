    ...
    render () {
        ...
        return <span className="borjes" style={containerStyle}>
            <div ref={d=>this.dom.nodeWrapper=d} style={nodeStyle}>
                <BorjesComponent x={x.node} globalProps={globalProps} refresh={ub} update={this.update.bind(this, -1)} opts={copy_opts(x.node)} />
            </div>
            ...
            <div style={childrenStyle}>
                {x.children.map((c, i) => <span ref={d=>this.dom["child"+i]=d} key={"child"+i}>{this.state.shown[i]
                        ?<BorjesComponent x={c} globalProps={globalProps} refresh={ub} update={this.update.bind(this, i)} opts={copy_opts(c)} />
