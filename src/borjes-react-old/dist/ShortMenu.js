...
var ShortMenu = function (_React$Component) {
    _inherits(ShortMenu, _React$Component);

    function ShortMenu(props) {
        _classCallCheck(this, ShortMenu);

        var _this = _possibleConstructorReturn(this, (ShortMenu.__proto__ || Object.getPrototypeOf(ShortMenu)).call(this, props));

        _this.state = { show: false, off: _this.off.bind(_this) };
        return _this;
    }

    _createClass(ShortMenu, [{
        key: "on",
        value: function on(e) {
