        ...
        switch (x.borjes) {
            ...
            case 'fstruct':
                if (FStruct.get(x, 'symbol') !== undefined) {
                    ...
                    return <span className="borjes"><BorjesAVM ref="child" decl={this.props.decl} x={x} doc={doc} file={file} refresh={refresh} update={update} opts={opts} /></span>;
                }
            case 'list_empty':
            case 'list':
                return <span className="borjes"><BorjesList x={x} file={file} refresh={refresh} edit={edit} update={update} opts={opts} /></span>;
            case 'variable':
                return <span className="borjes"><BorjesVariable ref="child" x={x} file={file} refresh={refresh} edit={edit} update={update} opts={opts} /></span>;
            case 'latticeel':
                return <span className="borjes"><BorjesLatticeElement x={x} file={file} refresh={refresh} edit={edit} update={update} opts={opts} /></span>;
            case 'disjunct':
                return <span className="borjes"><BorjesDisjunct x={x}  file={file} refresh={refresh} edit={edit} update={update} opts={opts} /></span>;
 /*           case 'set':
